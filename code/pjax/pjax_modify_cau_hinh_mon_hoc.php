...
<?php if (isset($_SERVER['HTTP_X_PJAX']) && $_SERVER['HTTP_X_PJAX'] == 'true'): ?>
	<?php require_once "../phong_lab/modify_cau_hinh_mon_hoc.php"?>
	<script src="../script/script_modify_cau_hinh.js?=<?php echo rand() ?>"></script>
...
<?php else: ?>
	...
	<script src="../script/script_modify_cau_hinh.js"></script>
	<hr>
