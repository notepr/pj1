...
<?php if (isset($_SERVER['HTTP_X_PJAX']) && $_SERVER['HTTP_X_PJAX'] == 'true'): ?>
	<?php require_once "../phong_lab/add_cau_hinh.php"?>
	<script src="../script/script_add_cau_hinh.js?=<?php echo rand() ?>"></script>
...
<?php else: ?>
	...
	<script src="../script/script_add_cau_hinh.js"></script>
	<hr>
