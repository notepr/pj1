...
<?php if (isset($_SERVER['HTTP_X_PJAX']) && $_SERVER['HTTP_X_PJAX'] == 'true'): ?>
	<?php require_once "../phong_lab/modify_tinh_trang_may.php"?>
	<script src="../script/script_modify_tinh_trang_may.js?=<?php echo rand() ?>"></script>
...
<?php else: ?>
	...
	<script src="../script/script_modify_tinh_trang_may.js"></script>
	<hr>
