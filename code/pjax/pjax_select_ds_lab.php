...
<?php if (isset($_SERVER['HTTP_X_PJAX']) && $_SERVER['HTTP_X_PJAX'] == 'true'): ?>
    <?php require_once "../phong_lab/select_danh_sach_lab.php"?>
	<script src="../script/script_select_ds_lab.js?=<?php echo rand() ?>"></script>
...
<?php else: ?>
	<?php require_once "../view/header.php"?>
		...
		<script src="../script/script_select_ds_lab.js"></script>
		<hr>
