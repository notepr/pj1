...
function dieu_kien_1($gio_phat_sinh, $gio_day)
{
...
function dieu_kien_2($gio_phat_sinh, $gio_day)
{
...
function So_sanh_ngay_hien_tai($ngay_so_sanh)
{
...
function Check_gio($moc_1, $moc_2)
{
...
function Moc_gio($gio_bat_dau, $gio_ket_thuc)
{
    if (chuyen_gio($gio_bat_dau) == 8 && chuyen_gio($gio_ket_thuc) == 10) {
        return 1;
    }
    if (chuyen_gio($gio_bat_dau) == 10 && chuyen_gio($gio_ket_thuc) == 12) {
        return 2;
    }
    if (chuyen_gio($gio_bat_dau) == 13.5 && chuyen_gio($gio_ket_thuc) == 15.5) {
        return 3;
    }
    if (chuyen_gio($gio_bat_dau) == 15.5 && chuyen_gio($gio_ket_thuc) == 17.5) {
        return 4;
    }
    if (chuyen_gio($gio_bat_dau) == 8 && chuyen_gio($gio_ket_thuc) == 12) {
        return 5;
    }
    if (chuyen_gio($gio_bat_dau) == 13.5 && chuyen_gio($gio_ket_thuc) == 17.5) {
        return 6;
    }
}
//.end
...
while ($d_xep_tu_ngay <= $d_xep_den_ngay) {
    ...
    if (So_sanh_ngay_hien_tai($d_xep_tu_ngay) == 'false' && Chuyen_thanh_thu_dung($day_of_the_week) != 8) {
        $dem++;
    }
    if ($dem == 1) {
        ...
        $thu_phan_cong   = Chuyen_thanh_thu_dung($day_of_the_week);
        ...
        foreach ($array as $each) {
            ...
            while ($gio_phat_sinh < chuyen_gio($each['gio_bat_dau']) && dieu_kien_1($gio_phat_sinh, $gio_day) == "true" && dieu_kien_2($gio_phat_sinh, $gio_day) == "true") {
                //Lưu đề xuất giờ lại thành 1 mảng
                $de_xuat[]     = array(
                    'ngay' => $d_xep_tu_ngay,
                    'thu' => $thu_phan_cong,
                    'gio_bat_dau' => chuoi_thanh_gio($gio_phat_sinh - $gio_day),
                    'gio_ket_thuc' => chuoi_thanh_gio($gio_phat_sinh)
                );
                $gio_phat_sinh = $gio_phat_sinh + $gio_day;
            }
            
            $gio_phat_sinh = chuyen_gio($each['gio_ket_thuc']);
        ...
        // die();
        $gio_phat_sinh = $gio_phat_sinh + $gio_day;
        while (dieu_kien_1($gio_phat_sinh, $gio_day) == "true" && dieu_kien_2($gio_phat_sinh, $gio_day) == "true") {
...
//láy số sv của lớp
$api       = "https://bkacad.xyz/code/database/api.php?key=" . $key_api . "&ma_lop=" . $ma_lop . "&thao_tac=ds_sinh_vien";
    ...
    foreach ($array_phong_chi_tiet as $each) {
        for ($i = 0; $i < count($de_xuat); $i++) {
            ...
            if (mysqli_num_rows($ban_ghi) != 0) {
                $moc_gio_so_sanh = Moc_gio($gio_bat_dau, $gio_ket_thuc);
                $ton_tai         = "";
                //so_sanh xem mốc giờ so_sanh có tồn tại trong dtb hay không
                foreach ($ban_ghi as $each_gio) {
                    $gio_sql = Moc_gio($each_gio['gio_bat_dau'], $each_gio['gio_ket_thuc']);
                    if (Check_gio($gio_sql, $moc_gio_so_sanh) == false) {
                        break;
                    }
